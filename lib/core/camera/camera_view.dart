...
class CameraViewController {
  Future<ui.Image?> Function()? captureFunc;

  Future<ui.Image> capture() async {
    if (captureFunc != null) {
      final image = await captureFunc!();
      if (image != null) return image;
    }
    throw Exception("Camera capture failed or not ready");
  }
}
...
class _CameraViewState extends State<CameraView> {
  ...
  void initState() {
    ...
    if (widget.controller != null) {
      widget.controller!.captureFunc = _capture;
    }
  }
  ...
  void didUpdateWidget(CameraView oldWidget) {
    ...
    if (oldWidget.controller != widget.controller) {
      oldWidget.controller?.captureFunc = null;
      widget.controller?.captureFunc = _capture;
    }
  }
  ...
  Future<ui.Image?> _capture() async {
    try {
      ...
      debugPrint("Error capturing camera view: $e");
      return null;
    }
  }
